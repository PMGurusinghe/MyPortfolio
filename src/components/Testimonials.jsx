    ...
    subtitle='Read what industry professionals and clients have to say about their experience working with me as a QA Engineer.'>
        <div className='max-w-xl flex flex-col gap-2'>
            {TESTIMONIALS.map(({id, image, name, comment}) => (
                <div key={id} className='flex p-2 mt-4 justify-center items-center rounded-xl shadow-md dark:shadow-gray-300 duration-300 ease-in-out hover:scale-110'>
                    <div className='w-2/6'>
                        <img src={image} alt={name} className="w-20 object-cover ml-10 pt-2"/>
                    </div>
                    <div className='w-4/6 flex flex-col justify-center items-center gap-3 p-2'>
